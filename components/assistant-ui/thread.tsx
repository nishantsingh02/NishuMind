      ...
      <div className="mx-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col px-[var(--thread-padding-x)]">
        ...
        <div className="flex w-full flex-grow flex-col items-center justify-center">
          ...
          <div className="flex size-full flex-col justify-center px-8 md:mt-20">
            ...
            <BlurText
  text="Nishu here, how may I help you?"
...
const ThreadWelcomeSuggestions: FC = () => {
  return (
    ...
    <div className="grid w-full gap-2 sm:grid-cols-2">
      {[
        {title: "How to fix",
          label: "my sleep cycle finally?",
          action: "How to fix my sleep cycle?",
          
        },
        {
          title: "Best way",
          label: "to reduce Call of Duty gaming hours?",
          action: "Best way to reduce COD gaming hours?",
        },
        {
          title: "Any hacks",
          label: `to not waste half my day scrolling?`,
          action: `Any hacks to not waste half my day scrolling?`,
        },
        {
          title: "Is it possible",
          label: "to score 9 CGPA by studying just one night?",
          action: "How to score 9 CGPA by studying one night before exam?",
        },
